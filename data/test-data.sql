...
('Parte 8: Cómo crear un panel de administración con Symfony 6', 'static/posts/crear-panel-administracion-symfony-6.png', '<p>En este tutorial vamos a ver c&oacute;mo crear f&aacute;cilmente un potente panel de administraci&oacute;n con <strong>Symfony 6</strong> de forma sencilla paso a paso.</p>
...
('Parte 7: Cómo crear formularios con Symfony 6', 'static/posts/formularios-symfony-6.png', '<p>En el tutorial de esta semana vamos a ver <strong>como crear formularios con Symfony 6</strong>, guardar informaci&oacute;n, validar datos y restringir para que solo lo puedan utilizar usuarios autenticados.</p>
...
('Parte 6: Autenticación y registro con Symfony 6', 'static/posts/autenticacion-registro-symfony-6.png', '<p>En el tutorial de esta semana vamos a aprender&nbsp;<strong>como generar autom&aacute;ticamente el sistema de registro y autenticaci&oacute;n con Symfony 6</strong>. Gracias a las herramientas que incluye <strong>Symfony 6</strong>, este realizar&aacute; la mayor parte del trabajo y nosotros solo tendremos que realizar unos peque&ntilde;os ajustes para ponerlo a punto 💪.</p>
...
('Parte 3: Cómo crear datos falsos en una base de datos con Symfony 6', 'static/posts/como-crear-datos-falsos-base-de-datos-symfony-6.png', '<p>En este tutorial aprenderemos a usar herramientas para facilitar la creaci&oacute;n de datos falsos en nuestra base de datos para un proyecto con <strong>Symfony 6</strong>.</p>
...
('Parte 2: Cómo crear entidades, migraciones y conectarnos a una base de datos con Symfony 6', 'static/posts/crear-entidades-migraciones-conexion-base-de-datos-symfony-6.png', '<p>En este tutorial vamos a ver c&oacute;mo <strong>conectarnos a una base de datos</strong> <strong>y crear las entidades que despu&eacute;s nos servir&aacute;n para crear las tablas autom&aacute;ticamente con Symfony 6</strong>.</p>
...
('Parte 1: Cómo crear una webapp con Symfony 6', 'static/posts/crear-web-app-symfony-6.png', '<p>En este tutorial vamos a ver como crear una web completa y paso a paso con el Framework de <strong>Symfony 6</strong>&nbsp;y <strong>PHP 8.1</strong>.</p>
...
('¿Qué es CQRS (Command Query Responsibility Segregation)?', 'static/posts/que-es-cqrs.png', '<p>La abreviatura <strong>CQRS </strong>que significa <strong>Command Query Responsibility Segregation</strong> (separaci&oacute;n de la responsabilidad de consultas y comandos) es un patr&oacute;n de dise&ntilde;o de software el cual separa las consultas (recuperar datos) de los comandos (inserci&oacute;n, actualizaci&oacute;n y borrado de datos).</p>
